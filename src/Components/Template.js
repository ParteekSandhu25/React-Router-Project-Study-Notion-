...
function Template({ title, desc1, desc2, image, formtype, setIsLoggedIn }) {
  return (
    <div className="mx-auto flex flex-col-reverse item-center md:flex-row justify-evenly md:justify-between w-11/12 max-w-[1160px] gap-x-12 py-12 gap-y-0 h-[185vh] md:h-auto">
